<?php
//session_start();
include_once "../../sc_include/sc.func.php" ;
include_once "../../../sc.web.php" ;
include_once "../../.".SYSCORE_LOC."system/func.database.php" ;    
include_once "../../.".SYSCORE_LOC."system/func.php" ;
...
$current_path 	= '../../../uploaded/'; // relative path from filemanager folder to upload folder (with final /)
